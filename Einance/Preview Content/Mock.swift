...
extension Current {
    static var preview = Current(.preview, .preview)
}
...
extension Card {
    static var preview = Card(id: -1, name: "伙食費", amount: 1500, records: [
    ...
    static var preview2 = Card(id: -2, name: "債務", amount: 0, display: .forever, records: [
    ...
    static var preview3 = Card(id: -3, name: "空的", amount: 10000, display: .forever, records: [], color: .cyan)
}
